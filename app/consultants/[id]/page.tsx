...
const LazyLoadedComponent = dynamic(() => import("@/components/Consultants/ScoreConsultantModal"), {
        ...
        <main className="flex flex-col gap-6 max-w-2xl mx-auto">
          ...
          <div className="w-full flex items-center justify-between gap-6">
            <Button
              icon={
                <>
                  <Image src={"/assets/icons/shared/call.svg"} width={20} height={20} alt="call icon" />
                </>
              }
            ...
            <Button
              icon={
                <>
                  <Image src={"/assets/icons/shared/message.svg"} width={20} height={20} alt="call icon" />
                </>
              }
              width="flex items-center justify-center w-full"
              containerClass="w-full"
      ...
      >
        ...
        <div className=" w-full flex flex-col">
          <header className="flex items-center justify-center sticky select-none z-[40]   shadow-md   bg-white w-full transition-all top-0 h-16 px-6 py-4">
            ...
            <button onClick={handleHideModal} className="text-2xl text-gray-500 absolute right-4 top-4">
              x
            </button>
          </header>
          <LazyLoadedComponent />
