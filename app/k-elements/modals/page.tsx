...
const Page = () => {
    ...
    const [sliderCommissionValue, setSliderCommissionValue] =
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-6">
                ...
                <button onClick={() => toggleModal("modal4")}>
                    Show Modal 4
                </button>
                <button onClick={() => toggleModal("modal5")}>
                    Show Modal 5
                </button>
            </div>
            ...
            >
                ...
                >
                    <div className="px-6">
                        <p>
                            لورم ایپسوم دولور سیمی‌ت، ایزی اومنیس ودی ایرودت.
                            نسسیت اتم‌دور تریور، فولوتوت ان سیفلکس، ویدور آت.
                            کیا دسیمپ، ییستیداتی پسولاتی! اپتور لوکوس ویگورن
                            اوپریتستات واریتر، کولیسیا بلانکیتور. توسیتان ریتلات
                            که دیسپوسل ایترسیتی اش. سلیم رتیو لورکاتور، هر پورو
                            پتو.
                        </p>
                    </div>
                    ...
                    <div className="px-6">
                        ...
                        <div className="flex flex-col gap-3 text-primary-700 pt-6 pb-10">
                            ...
                            <RangeWithTitle
                                ...
                                setValue={handleSliderTodayCommissionValue}
                                max={50}
                                min={0}
                                marks={{
                                    0: {
