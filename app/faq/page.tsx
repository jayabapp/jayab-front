    ...
    child: [
      {
        ...
        description: "برای ساخت حساب کاربری، به صفحه ثبت‌نام بروید و اطلاعات مورد نیاز خود را وارد کنید.",
      },
      {
        title: "چگونه وارد حساب کاربری شوم؟",
        description: "برای ورود به حساب کاربری خود، کافی است نام کاربری و رمز عبور خود را وارد کنید.",
      },
      {
      ...
      },
      {
        ...
        description: "بله، شما می‌توانید رزرو خود را لغو کنید، اما بسته به شرایط لغو، هزینه‌هایی ممکن است اعمال شود.",
      },
      {
      ...
      },
      {
        ...
        description: "بعضی از اقامتگاه‌ها پارکینگ دارند. در توضیحات هر اقامتگاه به طور مشخص اشاره شده است.",
      },
      {
        title: "چگونه هزینه اقامتگاه را پرداخت کنم؟",
        description: "هزینه اقامتگاه را می‌توانید از طریق درگاه‌های پرداخت آنلاین معتبر پرداخت کنید.",
      },
      {
        title: "چگونه با مشکل پیش‌آمده در اقامتگاه برخورد کنم؟",
        description: "در صورت بروز هرگونه مشکل در اقامتگاه، با پشتیبانی ما تماس بگیرید تا به سرعت مشکل شما حل شود.",
      },
    ],
  },
  {
            ...
            {faq_data.map((tab, tabIndex) => (
              <div
                ...
                className={`w-full md:w-1/5 inline-flex items-center justify-start gap-3 h-14 ${
                  activeTab === tabIndex ? "bg-primary-700 text-white" : "bg-primary-100 text-primary-700"
            ...
            return (
              <div
                ...
                className={`transition-all bg-white duration-500 ${
                  activeTab === tabIndex ? "z-10 relative top-0 opacity-100" : "absolute top-20 opacity-0"
                }
                  ...
                  <div className="flex flex-col gap-4">
                    {firstHalf.map((faq, faqIndex) => (
                      <Accordion key={faqIndex} title={faq.title}>
                        <p className="text-sm sm:text-base">{faq.description}</p>
                      </Accordion>
                    ))}
                  </div>
                  <div className="flex flex-col gap-4">
                    {secondHalf.map((faq, faqIndex) => (
                      <Accordion key={faqIndex} title={faq.title}>
                        <p className="text-[inherit] text-sm">{faq.description}</p>
                      </Accordion>
                    ))}
                  </div>
                </div>
            ...
            <div>
              <MultiLineFormInput
                item={{
                  ...
                  isMandatory: true,
                  placeholder: _STRINGS.DESCRIPTION,
