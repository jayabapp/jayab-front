...
const Selecti = ({ item, value, onSelect, closeOnSelect, setShow, velueString }: SelectiType) => {
  return (
    <div
      ...
      className={` relative  flex w-full items-center gap-4 justify-center  border-t  first:border-t-0 cursor-pointer border-neutral-100 py-2 transition-all duration-700 ease-in-out`}
    >
      {closeOnSelect ? (
