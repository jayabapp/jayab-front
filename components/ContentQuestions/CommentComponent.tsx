    ...
    <div className="w-full flex flex-col ">
      <div className=" w-full flex flex-col  gap-4 p-3  border border-secondary-400 rounded-xl">
        <div className="flex  flex-row items-center justify-between">
          <div className=" flex items-center gap-1 border  border-primary-border  rounded-full pl-2 p-[1px]  ">
            {" "}
            <img src="/assets/icons/contents/gray_user_profile.svg" className="w-6 h-6  opacity-60" />{" "}
            <p className="text-sm  text-secondary-600 ">{item?.author_name}</p>
          </div>
          <div className="  flex  items-center gap-2 ">
            <img className="w-5 h-5 " src={"/assets/icons/products/gray_callendar.svg"} />
            <p className=" text-xs md:text-sm  text-secondary-700 ">{moment(Date.now()).format("jDD jMMMM jYYYY")}</p>
          </div>
        </div>
      ...
      {!!item?.answer && (
        <div className="w-full mt-4 flex flex-row items-center justify-between gap-4 ">
          <img src="/assets/icons/contents/arrow_curved_up.svg" className="!w-4 shrink-0  aspect-square  " />
            ...
            <div className="flex flex-row   items-center justify-between">
              ...
              <div className="  flex  items-center gap-2 ">
                ...
                <p className=" text-xs md:text-sm  text-secondary-700 ">
                  {moment(Date.now()).format("jDD jMMMM jYYYY")}
                </p>
              </div>
            </div>
