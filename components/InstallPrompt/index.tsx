...
const InstallPromt = ({
  ...
  return (
    <div
      className="fixed  app-size right-0 left-0 bottom-0 app-text  w-full md:w-2/3 xl:w-1/2  mx-auto bg-white shadow-card rounded-t-lg px-3 pt-8 pb-6 gap-2 z-30 cart-shadow "
      // style={{ maxWidth: 450 }}
    >
