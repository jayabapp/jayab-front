...
const IosPrompt = ({ callBack }: { callBack: () => void | null }) => {
  return (
    <div
      ...
      className="fixed pt-16 !bg-transparent  right-0 left-0 backdrop-brightness-50 bottom-0 app-text w-full mx-auto backdrop-blur-sm  custom-prompt-shadow  rounded-t-lg px-3  pb-6  z-30 cart-shadow  h-full flex flex-col gap-16"
    >
