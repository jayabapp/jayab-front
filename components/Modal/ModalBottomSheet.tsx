    ...
    <Transition show={show} as="div" className="fixed inset-0">
      <Dialog as="div" className="relative" style={{ zIndex: 1000 }} onClose={onHide}>
        ...
        >
          ...
          >
            <DialogPanel
              className={`mx-auto rounded-t-20 md:rounded-20 max-h-[90dvh] md:max-h-[75dvh] absolute pb-[1.5rem] md:pb-4 bottom-0 md:bottom-auto md:translate-x-1/2 md:right-1/2 w-full md:w-[calc(35svw)]  overflow-y-scroll bg-white dark:bg-dark-700 ${options?.containerClass}`}
            >
              {children}
            </DialogPanel>
          </TransitionChild>
