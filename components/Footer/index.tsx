...
const Footer = () => {
  ...
  return (
    <div className="w-full  pb-20  mb:pb-6 bg-primary-200   hidden  lg:flex   flex-col items-center justify-center bg-dark-500  bg-no-repeat bg-cover  relative md:pt-[6rem] ">
      <CallBox />
