...
const LandingsContentSection = ({ data, options }: { data: Content; options: { parentPadding?: string } }) => {
  ...
  return (
    ...
    >
      ...
      <div className=" absolute  z-1 !rounded-b-10 md:!rounded-b-20 bottom-0 left-0 right-0 w-full py-4 md:py-8 bg-gradient-to-b from-white/0 via-white/80 to-white/100 flex items-center justify-center">
        <div
          onClick={() => {
            setIsOpen((e) => !e);
          }}
