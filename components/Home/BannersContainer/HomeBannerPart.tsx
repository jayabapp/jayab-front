  ...
  return (
    ...
    >
      ...
      <div className="w-full extra-padding-x  lg:!px-[28%] flex absolute m-auto left-0 right-0  bottom-[35%] lg:bottom-[30%] flex-col   z-10 lg:z-1  gap-20">
        ...
        <div className=" flex backdrop-blur-md   shadow-card lg:shadow-none  lg:backdrop-blur-none    absolute bottom-[-70%]  w-[90%] left-0 right-0 mx-auto  lg:relative  lg:h-14 lg:bg-white rounded-full items-center  gap-1 lg:gap-2    p-[1px]   lg:pl-4">
          <SearchBoxDropDown
